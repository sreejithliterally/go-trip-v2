      ...
      schemas: {
        ...
        RoomTypeRequest: {
          ...
          properties: {
            ...
            defaultAdultOccupancy:  { type: 'integer', minimum: 1, default: 2 },
            maxAdultOccupancy:      { type: 'integer', minimum: 1, default: 3 },
            defaultChildOccupancy:  { type: 'integer', minimum: 0, default: 0, description: 'Children aged 2–12' },
            maxChildOccupancy:      { type: 'integer', minimum: 0, default: 2 },
            defaultInfantOccupancy: { type: 'integer', minimum: 0, default: 0, description: 'Infants under 2 (crib, no extra bed)' },
            maxInfantOccupancy:     { type: 'integer', minimum: 0, default: 2 },
            basePricePerNight:      { type: 'number', example: 2500 },
            extraAdultCharge:       { type: 'number', default: 0, description: 'Per extra adult per night beyond defaultAdultOccupancy' },
            extraChildCharge:       { type: 'number', default: 0, description: 'Per child per night' },
            extraInfantCharge:      { type: 'number', default: 0, description: 'Per infant per night' },
            amenityIds: {
              type: 'array',
